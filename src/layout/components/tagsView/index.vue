<template>
  <div id="tags-view-container" class="tags-view-container">
    <el-scrollbar wrap-class="tags-view-wrapper" class="scroll-container" ref="scrollPaneEl" @scroll="handleScroll"
      @wheel.prevent="scrollHandle" :tagRefList="tagRefList">
      <router-link :ref="setTagRef" v-for="tag in visitedViews" :key="tag.path"
