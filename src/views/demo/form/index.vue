      ...
      <div class="section-container">
        ...
        >
          ...
          <el-form-item label="活动区域" prop="region">
            <el-select v-model="formState.region" placeholder="请选择活动区域">
          ...
          <el-form-item label="即时配送" prop="delivery">
            <el-switch v-model="formState.delivery"></el-switch>
          </el-form-item>
          <el-form-item label="活动性质" prop="type">
            <el-checkbox-group v-model="formState.type">
